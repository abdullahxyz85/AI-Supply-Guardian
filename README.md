...
- **AI**: Custom AI agents for email processing and risk analysis
...
1. **Extraction Agent**: Reads emails and pulls out structured data (order IDs, dates, prices, etc.)
2. **Risk Analysis Agent**: Looks at the extracted data and flags potential issues with recommendations

Both agents are designed to work autonomously once you connect your Gmail. They process emails in the background and update your dashboard in real-time.
